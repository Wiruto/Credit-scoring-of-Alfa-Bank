...
11. [Установка проекта](#установка-проекта)
12. [Используемые зависимости](#используемые-зависимости)
13. [Авторы](#авторы)
...
- Данные клиентов банка должны быть представлены в табличной форме, описанной в разделе [Data](https://www.kaggle.com/competitions/alfa-bank-pd-credit-history/data) Kaggle сорeвнования от Альфа Банка;
...
Некоторые подпространства показали низкое качество на базовых моделях. Возможно имеет смысл    
